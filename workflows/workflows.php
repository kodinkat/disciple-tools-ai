...
/**
 * Class Disciple_Tools_AI_Workflows
 *
 * @since  1.11.0
 */
class Disciple_Tools_AI_Workflows {
    ...
    /**
     * Disciple_Tools_AI_Workflows The single instance of Disciple_Tools_AI_Workflows.
     *
     * @var    object
     * @access private
     * @since  1.11.0
    ...
    /**
     * Main Disciple_Tools_AI_Workflows Instance
     *
     * Ensures only one instance of Disciple_Tools_AI_Workflows is loaded or can be loaded.
     *
     * @return Disciple_Tools_AI_Workflows instance
     * @since  1.11.0
     */
    ...
    /**
     * Disciple_Tools_AI_Workflows constructor.
     */
        ...
        $workflows[] = (object) [
            ...
            'actions'    => [
                Disciple_Tools_Workflows_Defaults::new_action( Disciple_Tools_Workflows_Defaults::$action_update,
                    [
                        'id'    => 'disciple_tools_ai_text',
                        'label' => $dt_fields['disciple_tools_ai_text']['name']
                    ], [
...
Disciple_Tools_AI_Workflows::instance();
