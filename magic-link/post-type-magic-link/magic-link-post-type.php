...
/**
 * Class Disciple_Tools_AI_Magic_Link
 */
class Disciple_Tools_AI_Magic_Link extends DT_Magic_Url_Base {
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = '' ) {
        if ( $post_type === $this->post_type ){
            $tiles['dt_starters_magic_url'] = [
                'label' => __( 'Magic Url', 'disciple-tools-ai' ),
...
Disciple_Tools_AI_Magic_Link::instance();
