...
See instructions for refactoring and getting started in the [wiki](https://github.com/DiscipleTools/disciple-tools-ai/wiki)
See instructions for creating releases and publishing your plugin: [wiki](https://github.com/DiscipleTools/disciple-tools-ai/wiki)
...
# Disciple.Tools - Disciple Tools AI

This Plugin starts to integrate AI into Disciple Tools to help disciple makers in their work.
